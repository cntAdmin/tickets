  ...
  <div class="d-flex justify-content-start flex-row flex-wrap">
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-2">
      <div class="input-group w-100">
        ...
        <input class="form-control" type="text" :value="ticket.plate" disabled/>
      </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4 mt-2">
      <div class="input-group w-100">
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-2">
      <div class="input-group w-100">
        ...
        <input class="form-control" type="text" :value="ticket.brand ? ticket.brand.name : 'Sin Asignar'" disabled/>
      </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4 mt-2">
      <div class="input-group w-100">
        ...
        <input class="form-control" type="text" :value="ticket.car_model ? ticket.car_model.name : 'Sin Asignar'" disabled/>
      </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4 mt-2">
      <div class="input-group w-100">
        ...
        <input class="form-control" type="text" v-model="ticket.other_brand_model" disabled/>
      </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4 mt-2">
      <div class="input-group w-100">
        ...
        <input class="form-control" type="text" :value="ticket.ask_for ? ticket.ask_for.name : 'Sin Asignar'" disabled/>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-2">
      <div class="input-group w-100">
        <div class="input-group-prepend">
          <div class="input-group-text text-uppercase">Asignado a...</div>
        </div>
        <input class="form-control" type="text" :value="ticket.assigned_to ? ticket.assigned_to.name : 'Sin Asignar'" disabled/>
      </div>
    </div>
