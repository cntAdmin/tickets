                    ...
                    <tbody>
                        <tr v-for="ticket in tickets.data" :key="ticket.id">
                            ...
                            <td>
                                ...
                                <button v-if="ticket.deleted_at" class="btn btn-sm btn-danger" type="button" title="Cambiar estado" disabled>
                                    <i class="fa fa-trash"></i>
                                </button>
                                <button v-else-if="ticket.status.id == 1 " class="btn btn-sm btn-danger" type="button" title="Cambiar estado">
                                    <i class="fa fa-trash"></i>
                                </button>
                            </td>
                        </tr>
...
export default {
    ...
    methods: {
        ...
        check_length(to_check) {
            ...
            if(to_check === 'customer' && (this.customer_id.length === 0 || this.customer_id.length > 2)){
                this.emit_to_parent();
            }
        },
