          ...
          <div class="form-inline">
            <div class="form-group col-12 col-md-6 col-lg-4">
              ...
              <div class="input-group w-100">
                ...
                <select v-model="selected.role_id" class="form-control" required>
                  <option value="" disabled>Seleccione un rol</option>
                  <option v-for="role in roles" :value="role.id" :key="role.id" class="text-capitalize">{{ role.name }}</option>
                </select>
              </div>
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4" v-if="selected.role_id > 4">
            ...
            <div class="form-group col-12 col-md-6 col-lg-4" v-else>
              ...
              <div class="input-group w-100">
                ...
                <select v-model="selected.department_id" class="form-control">
                  ...
                  <option v-for="dp in departments" :value="dp.id" :key="dp.id" class="text-capitalize">{{ dp.name }}</option>
                </select>
              </div>
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4">
            ...
            <div class="form-group col-12 col-md-6 col-lg-4 mt-2">
              ...
              <div class="input-group w-100">
                ...
                <input type="text" v-model="selected.surname" class="form-control" />
              </div>
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mt-2">
              ...
              <div class="input-group w-100">
                ...
                <input type="text" v-model="selected.username" class="form-control" required/>
              </div>
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mt-2">
              ...
              <div class="input-group w-100">
                ...
                <input type="text" v-model="selected.phone" class="form-control" />
              </div>
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mt-2">
              ...
              <div class="input-group w-100">
                ...
                <input type="email" v-model="selected.email" class="form-control" />
              </div>
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mt-2">
              ...
              <div class="input-group w-100">
                ...
                <input type="password" v-model="selected.password" class="form-control" required/>
              </div>
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mt-2">
              ...
              <div class="input-group w-100">
                ...
                <input type="password" v-model="selected.password_confirmation" class="form-control" required/>
              </div>
            </div>
          </div>
